...
VALUES
    ...
    ('Q2 Qu''y a t-il dans votre dressing ?', 4),
    ('Q2 Qu''y a t-il dans votre dressing ?', 5),
    ('Q2 Qu''y a t-il dans votre dressing ?', 6),
    ('Q3 Quel genre de consommateur êtes-vous ?', 7),
    ...
    ('Q5 Pour boire mon café (ou ma bière) :', 15),
    ('Q6 Vous mangez bio :', 16),
    ('Q6 Vous mangez bio :', 17),
    ('Q6 Vous mangez bio :', 18),
    ('Q7 Pour nettoyer la maison, vous utilisez :', 19),
    ('Q7 Pour nettoyer la maison, vous utilisez :', 20),
    ('Q7 Pour nettoyer la maison, vous utilisez :', 21),
    ('Q8 Pour trier mes déchets :', 22),
    ('Q8 Pour trier mes déchets :', 23),
    ('Q8 Pour trier mes déchets :', 24),
    ('Q9 Votre moyen de transport :', 25),
    ('Q9 Votre moyen de transport :,', 26),
    ('Q9 Votre moyen de transport :', 27),
    ('Q10 Avez-vous déjà adopter la gourde ?', 28),
    ('Q10 Avez-vous déjà adopter la gourde ?', 29),
    ('Q10 Avez-vous déjà adopter la gourde ?', 30);
